      ...
      content={
        <View style={{width : width/1.5, height : height, backgroundColor : '#ffa342'}}>
          ...
          <View style={{ flexDirection : 'column',}}>
            ...
            <TouchableOpacity style={{height : 50, width : width/1.5, }} onPress={()=>navigate('Dashboard')}>
                <View style={{flex : 1, flexDirection : 'row', }}>
                  <Icon active name='camera' style={{marginLeft:10, marginTop: 10, marginRight:5, color:'white'}}/>
            ...
            <TouchableOpacity style={{height : 50, width : width/1.5, }} onPress={()=>navigate('Dashboard')}>
                <View style={{flex : 1, flexDirection : 'row', }}>
                  <Icon active name='paper-plane' style={{marginLeft:10, marginTop: 10, marginRight:5, color:'white'}}/>
                <Text style={styles.pil1text}>
                  Back to user
                </Text>
                </View>
